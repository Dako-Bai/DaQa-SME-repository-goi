...
const translations = {
  kz: {
    ...
    desc: '«Smart Mercury Energy» — Қазақстандағы мұнай өнімдері мен авиациялық отын логистикасын сенімді және қауіпсіз басқаратын жоғары технологиялық компания. Біз халықаралық стандарттарға және JIG-2 қауіпсіздік талаптарына толық сай келетін инфрақұрылымдарды ұсынамыз.',
    address_label: 'Мекенжай:',
    address_val: 'Алматы қаласы, Түрксіб ауданы, Свободная көшесі, 136/2',
    phone_label: 'Телефон:',
    email_label: 'Электрондық пошта:',
    hours_label: 'Жұмыс уақыты:',
    hours_val: 'Дүйсенбі - Жұма: 09:00 - 18:00',
  ...
  ru: {
    ...
    desc: '«Smart Mercury Energy» — высокотехнологичная компания, обеспечивающая надежное и безопасное управление логистикой нефтепродуктов и авиационного топлива в Казахстане. Наша инфраструктура полностью соответствует международным стандартам безопасности JIG-2.',
    address_label: 'Адрес:',
    address_val: 'г. Алматы, Турксибский район, ул. Свободная, 136/2',
    phone_label: 'Телефон:',
    email_label: 'Электронная почта:',
    hours_label: 'Режим работы:',
    hours_val: 'Понедельник - Пятница: 09:00 - 18:00',
    form_title: 'Обратная связь',
    form_desc: 'Свяжитесь с нами по любым вопросам или сотрудничеству.',
  ...
  en: {
    ...
    desc: 'Smart Mercury Energy is a high-tech company that provides reliable and secure logistics management for petroleum and aviation fuel in Kazakhstan. Our storage and distribution infrastructure fully complies with international JIG-2 safety standards.',
    address_label: 'Address:',
    address_val: '136/2 Svobodnaya Street, Turksibsky District, Almaty, Kazakhstan',
    phone_label: 'Phone:',
    email_label: 'Email:',
    hours_label: 'Office Hours:',
    hours_val: 'Monday - Friday: 09:00 - 18:00',
    form_title: 'Feedback',
    form_desc: 'Contact us for any questions or commercial inquiries.',
...
export default function CompanyHub() {
  ...
  const t = translations[lang as 'kz' | 'ru' | 'en'] || translations.kz;
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6 sm:p-8 bg-[#245dff] border border-blue-400/20 rounded-2xl shadow-xl shadow-blue-650/20 text-white animate-fade-in">
      {/* Company Profile */}
      ...
      <div className="p-5 sm:p-6 bg-[#1d52e5] border border-blue-400/20 rounded-xl flex flex-col justify-between text-white border border-blue-400/20">
        ...
        {submitted ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
               type="submit"
               className="w-full py-2.5 rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-450 hover:to-amber-550 text-slate-950 font-extrabold text-xs uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm hover:shadow-md border border-amber-400/30"
            >
